...
<%
    ...
    dim sql2 
    sql2= "WHERE ProcductName LIKE '"&search&"'"
                                    ...
                                    <div class="col l-12 m-12 c-12">
                                        <div class="dashboard-product">
                                            <div class="dashboard-text">
                                                <h4>Category</h4>
                                                <a href="EditCategory.asp" class="dashboard-option-btn dashboard-create">Create</a>
                                            </div>
                                            <div class="form">
                                                <table>
                                                    <thead>
                                                    ...
                                                    <%
                                                            ...
                                                            sql1= " ORDER BY CategoryID  offset ? rows fetch next ? rows only"
                                                            connDB.open()
                                                            Set cmdPrep = Server.CreateObject("ADODB.Command")
                                                            cmdPrep.ActiveConnection = connDB
                                                            cmdPrep.CommandType = 1
                                                            ...
                                                            If Not IsEmpty(search) Then
                                                                sql = sql & " WHERE CategoryName LIKE ?" & sql1
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="dashboard-option">
                                                                    <a href="EditCategory.asp?id=<%=Result("CategoryID")%>" class="dashboard-option-btn dashboard-update"><i class="fa-solid fa-pen"></i></a>
                                                                    <a data-href="deleteCategory.asp?id=<%=Result("CategoryID")%>" class="dashboard-option-btn dashboard-delete" data-bs-toggle="modal" data-bs-target="#confirm-delete" title="Delete"><i class="fa-solid fa-trash-can"></i></a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <%
                                                ...
                                                <ul class="navigation">
                                                    <%
                                                        If (pages > 1) Then
                                                            If (Clng(page) >= 2) Then
                                                    %>
                                                                <li class="navigation-item"><a href="/dashboard/DBCategory.asp?page=<%=Clng(page) - 1%>&search=<%=search%>" class="navigation-link"><i class="fa-solid fa-chevron-left"></i></a></li> 
                                                    <%
                                                            End If

                                                            for i = 1 to range
                                                    %>
                                                                <li class="navigation-item "><a href="/dashboard/DBCategory.asp?page=<%=i%>&search=<%=search%>" class="navigation-link <%=checkPage(Clng(i)=Clng(page),"active")%>"><%=i%></a></li>
                                                    <%
                                                            Next

                                                            If (Clng(page) < pages) Then
                                                    %>
                                                                <li class="navigation-item"><a href="/dashboard/DBCategory.asp?page=<%=Clng(page) + 1%>&search=<%=search%>" class="navigation-link"><i class="fa-solid fa-chevron-right"></i></a></li>
                                                    <%      
                                                            End If  
                                                        End if
                                                    %>
